    ...
    <div class="row mb-2">
      <div class="col-md-6">
        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
          ...
          <img src="<?= $article->getImagePosts();?>"  height="250" alt="" srcset="">
           <img src=" <?= $article->getImagePosts2();?>  "  height="250" alt="" srcset="">
          </div>
        </div>
      </div>
      <?php endforeach; ?>
          ...
          <?php foreach($articles as $article):?>
            <div class="col">
              <div class="card shadow-sm">
                ...
                <img class="" src="<?= $article->getImagePosts();?> "  alt="" >
                <img class="" src="<?= $article->getImagePosts2();?>"  alt="" >
